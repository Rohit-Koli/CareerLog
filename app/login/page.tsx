            ...
            <form className="mt-12 space-y-6">
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="username" type="text" required className="w-full  text-sm border  px-4 py-3 pr-8 rounded-md outline-blue-600 border-b-white" placeholder="Enter user name" />
              ...
              <div>
                ...
                <div className="relative flex items-center border-b-white">
                  <input name="password" type="password" required className="w-full border  px-4 py-3 pr-8 rounded-md outline-blue-600" placeholder="Enter password" />
